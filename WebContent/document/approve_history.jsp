...
<body bgcolor="#dee7ff" leftMargin="0" background="" topMargin="0" marginheight="0" marginwidth="0">
	<table width="778" border="0" align="center" cellPadding="0" cellSpacing="0" borderColor="#ffffff" style="font-size: 10pt; margin: auto">
		<tr height=35>
			...
			<td align="center" width="120" background="images/title_left.gif" bgColor="#dee7ff">
				<font color="#f7f7f7">公文审批历史<font color="#FFFFFF">&nbsp;</font></font>
			</td>
	...
	<table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6" style="margin: auto">
		...
		<tr bgcolor="#EFF3F7" class="tableBody1">
			<td width="30%" height="37" align="center"><b>审批人</b></td>
		    <td width="30%" height="37" align="center"><b>审批时间</b></td>
		    <td width="40%" height="37" align="center"><b>审批意见</b></td>
		</tr>
		
		<s:if test="%{pager.list!=null}">
			<s:iterator value="pager.list" id="info">
				<tr bgcolor="#EFF3F7" class="tableBody1"
					onmouseover="this.bgColor = '#DEE7FF';"
					onmouseout="this.bgColor='#EFF3F7';">
					<td align="center"><s:property value="#info.approver.person.name"/></td>
					<td align="center">
						<s:if test="#info.approveTime != null">
						<s:date name="#info.approveTime" format="yyyy-MM-dd"/>
						</s:if>
					</td>
					<td align="center"><s:property value="#info.comment"/></td>
				</tr>
			</s:iterator>
		</s:if>
		...
		<tbody>
			<tr>
				<td height=28 align=right valign="middle" noWrap
					...
					<!-- 可以在这里插入分页导航条 -->
					<pg:pager url="info" items="${ pager.total }" export="currentPage=pageNumber">
						<pg:first>
							<a href="<%= pageUrl %>">首页</a>
						</pg:first>
						<pg:prev>
