	...
	<table width="778" border="0" align="center" cellPadding="0" cellSpacing="0" borderColor="#ffffff" style="font-size: 10pt; margin: auto">
		<tr height=35>
			...
			<td align="center" width="120" background="images/title_left.gif" bgColor="#dee7ff">
				<font color="#f7f7f7">我的公文管理<font color="#FFFFFF">&nbsp;</font></font>
			</td>
		...
		<tbody>
			...
			<tr>
				...
				<td height=14 align="left" vAlign=center noWrap>
					...
					<a href="document!approvedList">已审公文</a> | 
					<c:if test="${ mytag:hasPermission(login.id, 'document', 0) }">
					<a href="#" onclick="openWin('document!selectWorkflow','addworkflow',600,200);">添加公文信息</a>
					</c:if>
				</td>
			</tr>
			<tr>
			...
			<s:iterator value="pager.list" id="document">
				<tr bgcolor="#EFF3F7" class="tableBody1"
					...
					<td align="center">
						...
						<a href="#" onclick="openWin('document!submitInput?document.id=<s:property value="#document.id"/>');">提交文档</a>&nbsp;
						</s:if>
						<c:if test="${ mytag:hasPermission(login.id, 'document', 3) }">
						<a href="#" onclick="del('document!delete?document.id=<s:property value="#document.id"/>');">删除文档</a>&nbsp;
						</c:if>
